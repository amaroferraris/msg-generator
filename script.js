...
// When I click on BORRAR TODO, generateMessageMaca continues to store the previous entries
function generateMessageMaca(mes, dia, precio, nombre, clases, preciocasa, casa, id) {
